...
export const CHAT_SESSIONS_STORAGE_KEY = 'chat_sessions_v1';
export const CHAT_WORKING_MEMORY_STORAGE_KEY = 'chat_working_memory_v1';
export const CHAT_LONG_TERM_MEMORY_STORAGE_KEY = 'chat_long_term_memory_v1';
export const LONG_TERM_MEMORY_LIMIT = 100;
