...
var _ymap = __webpack_require__(37);

ymaps.ready(_ymap.initMap);
...
var Popup = function () {
    ...
    (0, _createClass3.default)(Popup, [{
        key: 'initPopup',
        value: function initPopup(node) {
            var popup = document.querySelector(node);
            ...
            popup.innerHTML = __webpack_require__(82)();
        ...
        key: 'popupDragDrop',
        value: function popupDragDrop(popup) {
            var titleWindow = popup.querySelector('.w_title');

            titleWindow.addEventListener('mousedown', this.startDragDrop);
        }
    }, {
        key: 'startDragDrop',
        value: function startDragDrop(event) {
            var target = event.target;
            var body = document.body;
            var window = target.closest('.w_popup__win');
            var windowBound = window.getBoundingClientRect();
        ...
        key: 'clearPopup',
        value: function clearPopup(popup) {
            if (popup.innerHTML) {
                popup.innerHTML = "";
            }
        }
        ...
        key: 'getBtnAdd',
        value: function getBtnAdd() {
            return this.btnAddComment;
        }
    }, {
        key: 'getBtnClose',
        value: function getBtnClose() {
            return this.btnClosePopup;
        }
    }, {
        key: 'setCoords',
        value: function setCoords(coords) {
            var popupBound = this.popup.getBoundingClientRect();
            var widthPopup = popupBound.width;
        ...
        key: 'getValueForm',
        value: function getValueForm() {
            var form = this.getInputForm();
            var name = form.name;
            var place = form.place;
            var comment = form.comment;

            if (this.isEmptyInput(name) || this.isEmptyInput(place) || this.isEmptyInput(comment)) {
                return false;
            }
        ...
        key: 'isEmptyInput',
        value: function isEmptyInput(node) {
            var result = this.isEmpty(node.value);
        ...
        key: 'getInputForm',
        value: function getInputForm() {
            var form = this.form;
            var inputName = form.querySelector('.w_form-name');
            var inputPlace = form.querySelector('.w_form-place');
            var areaComment = form.querySelector('.w_form-com');
        ...
        value: function getFieldId() {
            var inputId = this.form.querySelector('.w_form-id');
        ...
        key: 'setListComments',
        value: function setListComments(arComments) {
            var _this = this;

            var result = '';
            var container = this.contCommentPopup;
            arComments.forEach(function (comment) {
                result += _this.prepareComment(comment);
            });
        ...
        key: 'prepareComment',
        value: function prepareComment(comment) {
            var templateComment = __webpack_require__(81);

            return templateComment({ comment: comment });
        }
    }, {
        key: 'addCommentList',
        value: function addCommentList(comment) {
            var container = this.contCommentPopup;
            var commentText = this.prepareComment(comment);
            var ul = document.createElement('ul');
            var li = void 0;
            var lis = container.querySelectorAll('li');

            if (lis.length == 1) {
                var bDel = lis[0].dataset.delete;
...
var _popup2 = __webpack_require__(36);
...
function initMap() {
    var map = getMap();
    var cluster = getClasterer();
    var options = { map: map, cluster: cluster };
    ...
    function startClusterEvent(e) {
        ...
        var coordsClick = e.get('pagePixels');
        var type = target.geometry.getType();
        var arGeoObjects = target.properties.get('geoObjects');
        var data = [];
        var mapContainer = document.querySelector('#' + getMapContainer());
        ...
        if (arGeoObjects) {
            ...
            var paramsComment = getParamsComment(data);
            var popup = new _popup3.default('#w_popup');
            var coordsPage = coordsClick;
            var opt = {
            ...
            openPopupComments(_options);
        }

        function clickMap(event) {
            if (event.target.classList.contains('link___placemark')) {
                var _target = event.target;
                var idComment = getIdPlacemark(_target);
                var arPlacemark = getArrPlacemarks(data, idComment);
                var _paramsComment = getParamsComment(arPlacemark);
                var _popup = new _popup3.default('#w_popup');
                var _coordsPage = coordsClick;
                var _opt = {
                    coords: _paramsComment.coords,
                    cluster: cluster,
                    popup: _popup,
                    address: _paramsComment.address
                };
                var _options2 = {
                    opt: _opt,
                    coordsPage: _coordsPage,
                    data: arPlacemark
                };

                openPopupComments(_options2);
...
function openPopupComments(options) {
    var popup = options.opt.popup;
    var funcAdd = addPlacemark.bind(null, options.opt);
    var funcClear = clearEventBtn.bind(null, popup);
...
function setMapEvent(options) {
    var map = options.map;
    var func = serveEventClickMap.bind(this, options);
...
function serveEventClickMap(options, e) {
    ...
    var coordsPage = e.get('pagePixels');
    ...
    getAddress(coords).then(function (res) {
        ...
        var funcAdd = addPlacemark.bind(null, opt);
        var funcClear = clearEventBtn.bind(null, popup);
...
function addPlacemark(opt) {
    var placemark = void 0;
    var valueForm = void 0;
    var dataPlacemark = void 0;
    var data = void 0;
...
function prepareDataPlacemark(valueForm) {
    var id = getIdComment(valueForm);
    var link = getLinkPlacemark(id, valueForm.address);
    var content = link + '<br>' + valueForm.comment + '<br>';
...
function getDate() {
    ...
    var mon = fmtDateNum(date.getMonth());
    var dateM = fmtDateNum(date.getDate());
    var hours = fmtDateNum(date.getHours());
    var min = fmtDateNum(date.getMinutes());
    var sec = fmtDateNum(date.getSeconds());
    var dt = year + '.' + mon + '.' + dateM;
...
function getIdComment(opt) {
    var inputId = opt.popup.getFieldId();
...
function getPlacemark(options) {
    return new ymaps.Placemark([options.coords[0], options.coords[1]], options.data, options.option);
}

function getMap() {
    var mapId = getMapContainer();
...
function getNameGObj(objGeo) {
    var nameRaw = objGeo.geoObjects.get(0).properties.get('text');
...
function getIdPlacemark(link) {
    var idRaw = link.getAttribute('id');
    var id = idRaw.slice(idRaw.indexOf('_') + 1);
...
// module
exports.push([module.i, "body {\n  background-color: #eee; }\n\n#map {\n  width: 100%;\n  height: 800px;\n  background-color: #f0f0f0; }\n\n.w_popup__win {\n  width: 379px;\n  font-family: \"Fira Sans\";\n  box-sizing: border-box;\n  background-color: #fff;\n  border-radius: 10px;\n  position: absolute;\n  display: none; }\n  .w_popup__win .w_title {\n    background-color: #ff8663;\n    border-top-left-radius: 10px;\n    border-top-right-radius: 10px;\n    height: 44px;\n    line-height: 44px;\n    padding-left: 15px;\n    padding-right: 12px;\n    font-size: 12px;\n    position: relative;\n    cursor: default;\n    overflow: hidden; }\n    .w_popup__win .w_title span {\n      color: #fff; }\n    .w_popup__win .w_title .w_title-i {\n      position: relative;\n      top: 4px;\n      padding-right: 4px; }\n    .w_popup__win .w_title .w_close {\n      background-image: url(" + __webpack_require__(79) + ");\n      position: absolute;\n      float: right;\n      height: 14px;\n      width: 14px;\n      top: 50%;\n      right: 12px;\n      margin-top: -9px; }\n  .w_popup__win .w_body {\n    height: 135px;\n    border-bottom: 1px solid #f0f0f0;\n    margin: 15px 10px 18px 15px;\n    overflow: auto;\n    box-sizing: border-box; }\n    .w_popup__win .w_body .w_body-list ul {\n      padding: 0;\n      margin: 0;\n      list-style: none; }\n    .w_popup__win .w_body .w_body-list li {\n      font-size: 16px;\n      padding-right: 8px;\n      color: #4f4f4f;\n      padding-bottom: 24px; }\n      .w_popup__win .w_body .w_body-list li .w_body-date {\n        font-size: 14px; }\n      .w_popup__win .w_body .w_body-list li .w_body-li-body {\n        font-size: 15px; }\n    .w_popup__win .w_body .w_body-list .w_body-li-title {\n      padding-bottom: 6px;\n      color: rgba(79, 79, 79, 0.749); }\n    .w_popup__win .w_body .w_body-list .w_body-li-name {\n      font-weight: 700;\n      padding-right: 5px;\n      color: #4f4f4f; }\n  .w_popup__win .w_body::-webkit-scrollbar {\n    width: 3px; }\n  .w_popup__win .w_body::-webkit-scrollbar-thumb {\n    background: rgba(0, 0, 0, 0.3); }\n  .w_popup__win .w_com {\n    margin: 15px 14px;\n    padding-bottom: 13px; }\n    .w_popup__win .w_com .w_com-title {\n      color: #ff8663;\n      font-weight: 600;\n      text-transform: uppercase;\n      padding-bottom: 9px; }\n    .w_popup__win .w_com input, .w_popup__win .w_com textarea {\n      border: 1px solid #c4c4c4;\n      border-radius: 15px;\n      font-size: 15px;\n      color: #333;\n      width: 100%;\n      outline: none;\n      padding: 3px 11px;\n      margin-bottom: 14px;\n      box-sizing: border-box;\n      line-height: 180%;\n      font-family: \"Fira Sans\"; }\n    .w_popup__win .w_com textarea {\n      height: 130px;\n      resize: none;\n      line-height: 130%;\n      margin-bottom: 8px; }\n    .w_popup__win .w_com .w_form-footer {\n      text-align: right; }\n    .w_popup__win .w_com #w_form-send {\n      color: #fff;\n      background-color: #ff8663;\n      border-radius: 10px;\n      padding: 8px 16px;\n      border: 0;\n      outline: none;\n      font-size: 12px; }\n  .w_popup__win .is__empty {\n    border: 1px solid red !important; }\n\n.link___placemark {\n  padding-bottom: 12px;\n  display: inline-block; }\n", ""]);
...
module.exports = __webpack_require__.p + "img/icon_small_point.png";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<li>\r\n    <div class=\"w_body-li-title\">\r\n        <span class=\"w_body-li-name\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.name : stack1), depth0))
    + "</span>\r\n        "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.place : stack1), depth0))
    + "\r\n        <span class=\"w_body-date\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.date : stack1), depth0))
    + "</span>\r\n    </div>\r\n    <div class=\"w_body-li-body\">\r\n        "
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"w_title\">\r\n    <span>\r\n        <img src=\"" + __webpack_require__(80) + "\" alt=\"\" class = \"w_title-i\">\r\n        <span class=\"w_title-name\">\r\n            <!--## name popup ##-->\r\n        </span>\r\n    </span>\r\n    <a href=\"\" class=\"w_close\"></a>\r\n</div><!--w_title-->\r\n<div class=\"w_body\">\r\n    <div class=\"w_body-list\">\r\n        <ul>\r\n            <!--## list comments ##-->\r\n            <li data-delete = \"1\">Отзывов пока нет...</li>\r\n        </ul>\r\n    </div>\r\n</div><!--w_body-->\r\n<div class=\"w_com\">\r\n    <div class=\"w_com-title\">\r\n        ваш отзыв\r\n    </div>\r\n    <div class=\"w_form\">\r\n        <input type=\"text\" class=\"w_form-name\" placeholder=\"Ваше имя\">\r\n        <input type=\"text\" class=\"w_form-place\" placeholder=\"Укажите место\">\r\n        <textarea name=\"\" class=\"w_form-com\" placeholder=\"Поделитесь впечатлениями\"></textarea>\r\n        <div class=\"w_form-footer\">\r\n            <button id=\"w_form-send\">Добавить</button>\r\n        </div>\r\n    </div>\r\n</div><!--w_com-->";
},"useData":true});
...
/***/ })
/******/ ]);
//# sourceMappingURL=44bf4786f256daa8d543.js.map