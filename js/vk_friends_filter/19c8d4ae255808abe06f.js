...
var _vk = __webpack_require__(38);
...
var curItemsFriendAll = [];
var curItemsFriendFilter = [];

// open window
friendsDiv.addEventListener('click', function (event) {
    var target = event.target;
    var containerItemsAll = void 0,
        containerItemsFilter = void 0;
    ...
    if (!document.querySelector('#filter .window')) {
        var templateContainer = __webpack_require__(81);

        filterDiv.innerHTML = templateContainer();
    }

    containerItemsAll = (0, _dom.getContainers)().all;
    containerItemsFilter = (0, _dom.getContainers)().filter;
    (0, _dom.showFilter)(true);

    (0, _vk.login)().then(function () {
        return (0, _vk.callAPI)('friends.get', { v: 5.62, fields: ['city', 'country', 'photo_100'] });
    }).then(function (result) {
        var lisAll = void 0,
            lisFilter = void 0;

        if (localStorage.idsVKUser) {
            var idsUserFilter = JSON.parse(localStorage.idsVKUser);
            var sepLists = (0, _assets.separateUserLists)(result.items, idsUserFilter);

            containerItemsAll.innerHTML = (0, _vk.createFriendsList)(sepLists.all);
            containerItemsFilter.innerHTML = (0, _vk.createFriendsList)(sepLists.filter);
            lisAll = containerItemsAll.querySelectorAll('li');
            lisFilter = containerItemsFilter.querySelectorAll('li');
            (0, _dom.sortDomList)(lisAll, containerItemsAll);
            (0, _dom.sortDomList)(lisFilter, containerItemsFilter);
            curItemsFriendAll = (0, _dom.getList)(lisAll);
            curItemsFriendFilter = (0, _dom.getList)(lisFilter);
        } else {
            containerItemsAll.innerHTML = (0, _vk.createFriendsList)(result.items);
            lisAll = containerItemsAll.querySelectorAll('li');
            (0, _dom.sortDomList)(lisAll, containerItemsAll);
            curItemsFriendAll = (0, _dom.getList)(lisAll);
        }

        (0, _dom.getContainers)().all.addEventListener('mousedown', startDragDrop);
    }).catch(function () {
        alert('error open widow');
        (0, _dom.showFilter)(false);
    });
});
...
filterDiv.addEventListener('click', function (event) {
    ...
    if (target.classList.contains('icon_button')) {
        ...
        var item = target.closest('.window__list-block-item');

        if (!item) {
            return;
        }

        if (target.closest('#list_friends_all')) {
            //  add

            (0, _dom.addItem)(curItemsFriendFilter, item);
            (0, _dom.deleteItem)(curItemsFriendAll, item);
            (0, _dom.renderingList)({
                listAll: curItemsFriendAll,
                listFilter: curItemsFriendFilter
            });
        } else if (target.closest('#list_friends_filter')) {
            //  delete

            (0, _dom.addItem)(curItemsFriendAll, item);
            (0, _dom.deleteItem)(curItemsFriendFilter, item);
            (0, _dom.renderingList)({
                listAll: curItemsFriendAll,
                listFilter: curItemsFriendFilter
            });
    ...
    if (target.classList.contains('window__bottom-save')) {
        var contFilter = (0, _dom.getContainers)().filter;
        var arListFilter = (0, _dom.getList)(contFilter.querySelectorAll('li'));
        var arIds = [];

        arListFilter.forEach(function (elem) {
            arIds.push(elem.dataset.id);
        });

        localStorage.idsVKUser = (0, _stringify2.default)(arIds);
...
function startDragDrop(event) {
    ...
    var ul = (0, _dom.getContainers)().all;
    var containerFilter = document.querySelector('#list_friends_filter');
    var coordFilter = containerFilter.getBoundingClientRect();
    var target = event.target;
    var li = target.closest('li.window__list-block-item');
    var clickMouse = { X: event.pageX, Y: event.pageY };
    var liBound = li.getBoundingClientRect();
    var shiftCoord = {
    ...
    (0, _dom.getContainers)().all.ondragstart = function () {
        return false;
    };
    ...
    function dropFriend(event) {
        if (event.pageX > coordFilter.left && event.pageX < coordFilter.right && event.pageY > coordFilter.top && event.pageY < coordFilter.bottom) {

            (0, _dom.addItem)(curItemsFriendFilter, li);
            (0, _dom.deleteItem)(curItemsFriendAll, li);
            (0, _dom.renderingList)({
                listAll: curItemsFriendAll,
                listFilter: curItemsFriendFilter
            });
...
function separateUserLists(arrAllUsers, arrIdsUsersFilter) {
    var arListFriendAll = [];
    var arListFriendFilter = [];

    for (var i = 0; i < arrAllUsers.length; i++) {
        var elem = arrAllUsers[i];
...
exports.separateUserLists = separateUserLists;
...
function sortListFriends(item1, item2) {
    var name1 = getName(item1);
    var name2 = getName(item2);
...
function sortDomList(list, node) {
    var arList = getSortList(list);

    arList.forEach(function (elem) {
...
function deleteItem(arr, item) {
    var name1 = getName(item);

    for (var i = 0; i < arr.length; i++) {
        var name2 = getName(arr[i]);
...
function renderingList(options) {
    ...
    var containerAllList = cont.all;
    var containerFilterList = cont.filter;
    var arrAll = options.listAll;
    var arrFilter = options.listFilter;
    ...
    if (options.filterFlag && options.filterValue) {
        if (options.filterFlag == 'all') {
            ...
            arrFilter.forEach(function (elem) {
                if (isMatches(getName(elem), options.filterValue)) {
...
function getContainers() {
    var containerAllList = document.querySelector('#list_friends_all .window__list-block-items ul');
    var containerFilterList = document.querySelector('#list_friends_filter .window__list-block-items ul');
...
exports.sortDomList = sortDomList;
exports.deleteItem = deleteItem;
exports.addItem = addItem;
exports.renderingList = renderingList;
...
exports.createFriendsList = exports.callAPI = exports.login = undefined;
...
function createFriendsList(friends) {
    var templateFn = __webpack_require__(82);
...
// module
exports.push([module.i, "body {\n  font-family: \"Fira Sans\";\n  box-sizing: border-box; }\n\n.container {\n  width: 980px;\n  margin: 0 auto; }\n\n#filter {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: rgba(0, 0, 0, 0.4);\n  display: none; }\n\n.window {\n  width: 620px;\n  height: 490px;\n  font-size: 12px;\n  color: #4f4f4f;\n  margin: 45px auto 0;\n  font-family: \"Fira Sans\";\n  border-radius: 8px; }\n\n.window__title {\n  background-color: #ff8663;\n  position: relative;\n  border-top-left-radius: 8px;\n  border-top-right-radius: 8px; }\n  .window__title .window__title-text {\n    color: #fff;\n    font-size: 16px;\n    line-height: 45px;\n    padding-left: 15px; }\n  .window__title .window__title-close {\n    content: \"\";\n    position: absolute;\n    background-image: url(" + __webpack_require__(78) + ");\n    width: 14px;\n    height: 14px;\n    right: 14px;\n    top: 14px; }\n\n.window__search {\n  background-color: #f0f0f0;\n  height: 45px;\n  color: #e4e4e4; }\n  .window__search .input {\n    color: #000;\n    border-radius: 10px;\n    padding-left: 28px;\n    padding-top: 2px;\n    line-height: 23px;\n    outline: none;\n    width: 100%;\n    box-sizing: border-box;\n    font-size: 12px;\n    border-width: 0;\n    font-family: \"Fira Sans\";\n    background-color: #fff;\n    background-image: url(" + __webpack_require__(80) + ");\n    background-repeat: no-repeat;\n    background-position: 7px 5px; }\n  .window__search .window__search-edit:first-child {\n    padding: 10px 8px 10px 15px; }\n  .window__search .window__search-edit {\n    width: 50%;\n    padding: 10px 15px 10px 8px;\n    box-sizing: border-box;\n    float: left; }\n\n.window__list {\n  height: 355px;\n  background-color: #fff; }\n\n.window__bottom {\n  background-color: #f0f0f0;\n  height: 45px;\n  border-bottom-right-radius: 8px;\n  border-bottom-left-radius: 8px;\n  text-align: right;\n  line-height: 45px; }\n  .window__bottom .window__bottom-save {\n    margin-right: 7px; }\n\n.button {\n  background-color: #ff8663;\n  color: #fff;\n  font-size: 12px;\n  line-height: 30px;\n  text-align: center;\n  border-radius: 8px;\n  display: inline-block;\n  padding: 0 15px;\n  border: 0;\n  cursor: pointer; }\n\n#list_friends_all {\n  border-right: 1px solid #f0f0f0; }\n  #list_friends_all .icon_button {\n    position: absolute;\n    display: block;\n    outline: 0;\n    width: 16px;\n    height: 16px;\n    background-image: url(" + __webpack_require__(77) + ");\n    top: 50%;\n    margin-top: -8px;\n    right: 8px; }\n\n#list_friends_filter .icon_button {\n  position: absolute;\n  display: block;\n  outline: 0;\n  width: 14px;\n  height: 14px;\n  background-image: url(" + __webpack_require__(79) + ");\n  top: 50%;\n  margin-top: -8px;\n  right: 8px; }\n\n.window__list-block {\n  width: 50%;\n  box-sizing: border-box;\n  overflow: auto;\n  min-height: 100%;\n  padding-left: 15px;\n  padding-right: 15px;\n  height: 100%;\n  float: left; }\n  .window__list-block .window__list-block-items {\n    height: 323px;\n    overflow: auto; }\n  .window__list-block ul {\n    list-style: none;\n    padding: 0;\n    margin: 0;\n    border-bottom: 1px solid #f0f0f0; }\n  .window__list-block li:hover, .window__list-block .hover_clone {\n    background-color: #f0f0f0; }\n  .window__list-block .window__list-block-item {\n    border-top: 1px solid #f0f0f0;\n    height: 58px;\n    cursor: pointer;\n    padding-right: 30px;\n    position: relative;\n    box-sizing: border-box; }\n  .window__list-block .window__list-block-item.move_item {\n    position: absolute;\n    z-index: 100;\n    background-color: #f0f0f0;\n    box-shadow: 10px 10px 5px #909090; }\n  .window__list-block .window__list-block-title, .window__list-block .window__list-block-name {\n    color: #4f4f4f;\n    font-size: 12px;\n    font-weight: 700;\n    text-align: left; }\n  .window__list-block .window__list-block-title {\n    padding-top: 9px;\n    line-height: 20px;\n    height: 30px;\n    box-sizing: border-box;\n    border-bottom: 1px solid #f0f0f0; }\n  .window__list-block .window__list-block-name {\n    line-height: 60px;\n    margin-left: 60px; }\n  .window__list-block .window__list-block-img {\n    width: 52px;\n    float: left;\n    margin-top: 8px;\n    margin-left: 8px; }\n    .window__list-block .window__list-block-img img {\n      width: 45px;\n      height: 45px;\n      border-radius: 50%; }\n\n.friends__title {\n  text-align: center; }\n  .friends__title .friends__title-open {\n    display: block;\n    margin: 25px auto; }\n", ""]);
...
module.exports = __webpack_require__.p + "img/icon_add.png";

/***/ }),
/* 78 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "img/icon_close.png";

/***/ }),
/* 79 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "img/icon_remove.png";

/***/ }),
/* 80 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "img/icon_zoom.png";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"window\">\r\n    <div class=\"window__title\">\r\n        <div class=\"window__title-text\">\r\n            Выберите друзей\r\n        </div>\r\n        <a href=\"\" class=\"window__title-close\"></a>\r\n    </div>\r\n\r\n    <div class=\"window__search\">\r\n        <div class=\"window__search-edit\">\r\n            <input type=\"text\" class=\"input\" data-search = \"all\" placeholder=\"Начните вводить имя друга\">\r\n        </div>\r\n        <div class=\"window__search-edit\">\r\n            <input type=\"text\" class=\"input\" data-search = \"filter\" placeholder=\"Название\">\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"window__list\">\r\n        <div class=\"window__list-block\" id=\"list_friends_all\">\r\n            <div class=\"window__list-block-title\">Ваши друзья</div>\r\n            <div class=\"window__list-block-items\">\r\n                <ul></ul>\r\n            </div><!--window__list-block-items-->\r\n        </div><!--window__list-block-->\r\n        <div class=\"window__list-block\" id=\"list_friends_filter\">\r\n            <div class=\"window__list-block-title\">Друзья в списке</div>\r\n            <div class=\"window__list-block-items\">\r\n                <ul></ul>\r\n            </div><!--window__list-block-items-->\r\n        </div>\r\n\r\n    </div><!--window__list-->\r\n\r\n    <div class=\"window__bottom\">\r\n        <buttom class=\"window__bottom-save button\">Сохранить</buttom>\r\n    </div>\r\n</div><!--window-->";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <li class=\"window__list-block-item\" data-id = \""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\">\r\n        <div class=\"window__list-block-img\">\r\n            <img src=\""
    + alias4(((helper = (helper = helpers.photo_100 || (depth0 != null ? depth0.photo_100 : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"photo_100","hash":{},"data":data}) : helper)))
    + "\">\r\n        </div>\r\n        <div class=\"window__list-block-name\">\r\n            <div class=\"window__list-friend-name\">\r\n                "
...
var _handlebarsSafeString = __webpack_require__(97);
...
var _handlebarsRuntime = __webpack_require__(96);
...
var _decoratorsInline = __webpack_require__(85);
...
var _helpersBlockHelperMissing = __webpack_require__(87);

var _helpersBlockHelperMissing2 = _interopRequireDefault(_helpersBlockHelperMissing);

var _helpersEach = __webpack_require__(88);

var _helpersEach2 = _interopRequireDefault(_helpersEach);

var _helpersHelperMissing = __webpack_require__(89);

var _helpersHelperMissing2 = _interopRequireDefault(_helpersHelperMissing);

var _helpersIf = __webpack_require__(90);

var _helpersIf2 = _interopRequireDefault(_helpersIf);

var _helpersLog = __webpack_require__(91);

var _helpersLog2 = _interopRequireDefault(_helpersLog);

var _helpersLookup = __webpack_require__(92);

var _helpersLookup2 = _interopRequireDefault(_helpersLookup);

var _helpersWith = __webpack_require__(93);
